...
not in a way that would linger.

but it’s there.
making small noises at night.
running in place like it’s convinced that counts as going somewhere.

you told me to get it.
and at the time it felt like nothing.
just another small suggestion.
the kind that doesn’t carry weight until it does.
...
it’s just something that stayed.
longer than it needed to.

and now i’m waiting for it to go.
waiting for you to go with it.
    </p>
  );
}
